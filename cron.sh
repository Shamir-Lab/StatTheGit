...
$udocker run --containerauth --publish=27017:27017 --volume /specific:/mnt/specific --volume /run/shm:/dev/shm statistics_git bash  /specific/netapp5/gaga/tools/StatTheGit4TAU/run_inside_container.sh
